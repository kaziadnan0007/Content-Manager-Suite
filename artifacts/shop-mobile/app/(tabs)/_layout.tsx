  ...
  return (
    <NativeTabs>
      ...
      <NativeTabs.Trigger name="cart">
        ...
        <Label>Cart</Label>
        {totalItems > 0 && <Badge>{totalItems > 99 ? "99+" : String(totalItems)}</Badge>}
      </NativeTabs.Trigger>
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Cart",
          tabBarBadge: totalItems > 0 ? (totalItems > 99 ? "99+" : String(totalItems)) : undefined,
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Orders",
          tabBarIcon: ({ color }) =>
            isIOS ? <SymbolView name="list.bullet" tintColor={color} size={24} /> : <Feather name="package" size={22} color={color} />,
        }}
      />
      <Tabs.Screen
        name="profile"
